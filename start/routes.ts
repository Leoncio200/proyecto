...
Route.get('api/v2/sensores/obtener/:id', 'SensoresController.sensores');//mostarsensores
...
Route.post('api/v2/salones', 'SalonesController.addSalon').middleware(['auth']);//insertarSalones
